...
public class DashController : MonoBehaviour
{
    ...
    private void Update()
    {
        // TODO: Implement directional double-tap-key system for dashing? (currently using double-tap space)
        if (playerMovementController.state == MovementState.Jumping && Input.GetKeyDown(playerMovementController.keybinds.dashKey)) Dash();
